      ...
      <Modal isCentered isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <FormControl isRequired>
            ...
            <Input mb={4} placeholder='Insira o nome aqui:' />
          </FormControl>
          
          <FormControl isRequired>
            <FormLabel mb={2} >Endereço:</FormLabel>
            <Input mb={4} placeholder='Insira o endereço aqui:' />
          </FormControl>

          <FormControl isRequired>
            <FormLabel mb={2} >Telefone:</FormLabel>
            <Input mb={4} placeholder='Insira o telefone aqui:' />
          </FormControl>
          
          <FormControl isRequired>
            <FormLabel mb={2} >Email:</FormLabel>
            <Input mb={4} placeholder='Insira o email aqui:' />
          </FormControl>

          </ModalBody>
          <ModalFooter>
            <Button colorScheme='red' onClick={onClose}>Fechar</Button>
            <Button ml={2} colorScheme='yellow' >Cadastrar</Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
    </Box>
